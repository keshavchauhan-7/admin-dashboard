...
<<<<<<< HEAD
    ...
    { name: "Student", icon: ShoppingBag, color: "#8B5CF6", href: "/products" },
    { name: "Employers", icon: Users, color: "#EC4899", href: "/users" },
    { name: "Stats", icon: DollarSign, color: "#10B981", href: "/sales" },
